...
import { createTextbox } from '../objects/textbox';
import { getSystemClipboard } from './func';
import { createFImage } from '../objects/image';
import { handleMouseOutCorner } from '../controller';
